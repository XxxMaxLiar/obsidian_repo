...
Ок, лучше сделать отдельную директорию + в ней файл. Допустим, назовем директорию **auth** а файл - **auth.py**. После этого создаем класс и функцию в этом файле, как ты это делал